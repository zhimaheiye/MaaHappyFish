...
MaaHappyFish 的发行包会下载并组合以下第三方组件。它们不因本项目的 MIT License 而改变各自的许可证：

| 组件                                | 用途                    | 上游许可证与源码                                                                                                          |
| ----------------------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| MaaFramework / MaaFw Python binding | 自动化核心与 Python API | [LGPL-3.0](https://github.com/MaaXYZ/MaaFramework/blob/main/LICENSE.md) · [源码](https://github.com/MaaXYZ/MaaFramework)  |
